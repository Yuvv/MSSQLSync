namespace Sender
{
	partial class Sender
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnSettingHelper = new System.Windows.Forms.Button();
			...
			// btnSettingHelper
			// 
			this.btnSettingHelper.Location = new System.Drawing.Point(456, 104);
			this.btnSettingHelper.Name = "btnSettingHelper";
			this.btnSettingHelper.Size = new System.Drawing.Size(75, 23);
			this.btnSettingHelper.TabIndex = 32;
			this.btnSettingHelper.Text = "配置";
			this.btnSettingHelper.UseVisualStyleBackColor = true;
			this.btnSettingHelper.Click += new System.EventHandler(this.btnSettingHelper_Click);
			// 
			// Sender
			// 
			...
			this.Controls.Add(this.btnSettingHelper);
		...
		private System.Windows.Forms.Button btnSettingHelper;
	}
}
